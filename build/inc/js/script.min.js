...
}),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent;offsetParent&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?win.pageXOffset:val,top?val:win.pageYOffset):elem[method]=val)},method,val,arguments.length)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){if(computed)return computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?0===funcName.indexOf("outer")?elem["inner"+name]:elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable)}})}),jQuery.fn.extend({bind:function(types,data,fn){return this.on(types,null,data,fn)},unbind:function(types,fn){return this.off(types,null,fn)},delegate:function(selector,types,data,fn){return this.on(types,selector,data,fn)},undelegate:function(selector,types,fn){return 1===arguments.length?this.off(selector,"**"):this.off(types,selector||"**",fn)}}),jQuery.parseJSON=JSON.parse,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},noGlobal||(window.jQuery=window.$=jQuery),jQuery}),jQuery(function($){function Formstore(){$('input[name="most_enjoy"]').change(function(){localStorage[$(this).attr("name")]=$(this).val(),$(".blk_most_enjoy").css("display","none"),$(".blk_want_improve").css("display","block")}),$('input[name="want_improve"]').change(function(){localStorage[$(this).attr("name")]=$(this).val(),$(".blk_want_improve").css("display","none"),$(".blk_want_to").css("display","block")}),$('input[name="want_to"]').change(function(){localStorage[$(this).attr("name")]=$(this).val(),$(".blk_want_to").css("display","none"),$(".blk_main_form").css("display","block")}),$('input[type="radio"]').change(function(){"Diploma of Project Management"!=localStorage.most_enjoy&&"Diploma of Project Management"!=localStorage.want_improve&&"Diploma of Project Management"!=localStorage.want_to||$("#diploma_pm").css("display","block"),"Diploma of Business"!=localStorage.most_enjoy&&"Diploma of Business"!=localStorage.want_improve&&"Diploma of Business"!=localStorage.want_to||$("#diploma_business").css("display","block"),"Diploma of Marketing"!=localStorage.most_enjoy&&"Diploma of Marketing"!=localStorage.want_improve&&"Diploma of Marketing"!=localStorage.want_to||$("#diploma_marketing").css("display","block"),"Diploma of Leadership & Management"!=localStorage.most_enjoy&&"Diploma of Leadership & Management"!=localStorage.want_improve&&"Diploma of Leadership & Management"!=localStorage.want_to||$("#diploma_ls_man").css("display","block")}),$("#submit").click(function(){var name=$("#name").val(),email=$("#email").val(),phone=$("#phone").val();localStorage.getItem("most_enjoy"),localStorage.getItem("want_improve"),localStorage.getItem("want_to");if(""==name)return $("#name").addClass("hightlight"),!1;$("#name").removeClass("hightlight");var atpos=email.indexOf("@"),dotpos=email.lastIndexOf(".");return atpos<1||dotpos<atpos+2||dotpos+2>=email.length?($("#email").addClass("hightlight"),!1):($("#email").removeClass("hightlight"),""==phone?($("#phone").addClass("hightlight"),!1):($("#phone").removeClass("hightlight"),$("input[type=checkbox]").each(function(){if(!$(this).is(":checked"))return alert("Please you should accept the terms to proceed the process of sending. Thank you."),!1;$(".spa-loader").addClass("spa-loader-open"),$(".ipt-submit").addClass("hidden-ipt"),$.ajax({type:"POST",url:"email.php",data:$("#formideal").serialize(),dataType:"json",complete:function(r){document.getElementById("formideal").reset(),$(".spa-loader").removeClass("spa-loader-open"),$(".ipt-submit").removeClass("hidden-ipt"),$(".blk_main_form").css("display","none"),$(".msg_contact").css("display","block"),localStorage.clear()}})}),!1))})}Formstore()});